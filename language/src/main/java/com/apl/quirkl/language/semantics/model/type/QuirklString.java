...
public class QuirklString extends QuirklType<String> {
    ...
    public QuirklLongNum toLong() throws QuirklCastException {
        try {
            ...
            throw QuirklCastException.notCompatible(this.value, QuirklType.TYPE.LONG_NUMBER, this.getScope(), this.getCoord());
        }
    }
    ...
    public QuirklDoubleNum toDouble() throws QuirklCastException {
        try {
            ...
            throw QuirklCastException.notCompatible(this.value, QuirklType.TYPE.DOUBLE_NUMBER, this.getScope(), this.getCoord());
        }
    }
    ...
    public QuirklFunc toFunction() throws QuirklCastException {
        return QuirklFunc.cast(this.value, this.getTerm());
    }
