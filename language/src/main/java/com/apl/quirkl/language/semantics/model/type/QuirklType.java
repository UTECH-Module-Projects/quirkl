...
public abstract class QuirklType<T> {
    ...
    public QuirklType(T value, ProgTerm term) {
        this.value = value;
        this.term = term;
    }
    ...
    public final QuirklBool eq(QuirklType<?> other) throws QuirklMathException {
        ...
        return new QuirklBool(thisValue.getValue().equals(otherValue.getValue()), this.getTerm());
    }
    ...
    public abstract QuirklErr toError() throws QuirklCastException;
