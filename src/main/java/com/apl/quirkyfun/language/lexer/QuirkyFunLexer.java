package com.apl.quirkyfun.language.lexer;// Generated from QuirkyFun.g4 by ANTLR 4.13.1
...
public class QuirkyFunLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "LETTER", "DIGIT", "TRUE", 
	...
	public QuirkyFunLexer(CharStream input) {
		super(input);
