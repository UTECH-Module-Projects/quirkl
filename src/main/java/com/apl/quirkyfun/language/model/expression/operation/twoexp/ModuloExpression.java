...
@Getter
public class ModuloExpression extends TwoExpOperationExpression {

    protected ModuloExpression(Expression left, Expression right) {
        super(left, right);
    }

    public ModuloExpression(TwoExpOperationExpression exp) {
        super(exp);
    }
    ...
    public QuirkyNumber eval() throws QuirkyMathException {
        return ((QuirkyNumber) left.eval()).modulo((QuirkyNumber) right.eval());
    }
}
