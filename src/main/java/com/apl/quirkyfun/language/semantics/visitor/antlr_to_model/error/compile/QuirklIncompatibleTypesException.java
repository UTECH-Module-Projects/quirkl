...
import com.apl.quirkyfun.language.semantics.visitor.antlr_to_model.error.runtime.QuirklTypeException;
...
public class QuirklIncompatibleTypesException extends QuirklTypeException {
    ...
    public static QuirklIncompatibleTypesException invalidReturnType(Function func, String resultType, QuirklCoord coordinate) {
    ...
    public static QuirklIncompatibleTypesException invalidReturnType(Variable func, String resultType, QuirklCoord coordinate) {
